...
var rrGridOutput = registerRange{
	...
	replyFields: []field{
		...
		{0x0486, "ReactivePower_Output_Total", "I16", "0.01", "kvar"},
		{0x0487, "ApparentPower_Output_Total", "I16", "0.01", "kVA"},
		{0x0488, "ActivePower_PCC_Total", "I16", "0.01", "kW"},
		{0x0489, "ReactivePower_PCC_Total", "I16", "0.01", "kvar"},
		{0x048A, "ApparentPower_PCC_Total", "I16", "0.01", "kVA"},
		{0x048B, "GridOutput_Rsvd1", "", "", ""},
		{0x048C, "GridOutput_Rsvd2", "", "", ""},
		{0x048D, "Voltage_Phase_R", "U16", "0.1", "V"},
		{0x048E, "Current_Output_R", "U16", "0.01", "A"},
		{0x048F, "ActivePower_Output_R", "I16", "0.01", "kW"},
		{0x0490, "ReactivePower_Output_R", "I16", "0.01", "kvar"},
		{0x0491, "PowerFactor_Output_R", "I16", "0.001", "p.u."},
		{0x0492, "Current_PCC_R", "U16", "0.01", "A"},
		{0x0493, "ActivePower_PCC_R", "I16", "0.01", "kW"},
		{0x0494, "ReactivePower_PCC_R", "I16", "0.01", "kvar"},
		{0x0495, "PowerFactor_PCC_R", "I16", "0.001", "p.u."},
		{0x0496, "R_Rsvd1", "", "", ""},
		{0x0497, "R_Rsvd2", "", "", ""},
		{0x0498, "Voltage_Phase_S", "U16", "0.1", "V"},
		{0x0499, "Current_Output_S", "U16", "0.01", "A"},
		{0x049A, "ActivePower_Output_S", "I16", "0.01", "kW"},
		{0x049B, "ReactivePower_Output_S", "I16", "0.01", "kvar"},
		{0x049C, "PowerFactor_Output_S", "I16", "0.001", "p.u."},
		{0x049D, "Current_PCC_S", "U16", "0.01", "A"},
		{0x049E, "ActivePower_PCC_S", "I16", "0.01", "kW"},
		{0x049F, "ReactivePower_PCC_S", "I16", "0.01", "kvar"},
		{0x04A0, "PowerFactor_PCC_S", "I16", "0.001", "p.u."},
		{0x04A1, "S_Rsvd1", "", "", ""},
		{0x04A2, "S_Rsvd2", "", "", ""},
		{0x04A3, "Voltage_Phase_T", "U16", "0.1", "V"},
		{0x04A4, "Current_Output_T", "U16", "0.01", "A"},
		{0x04A5, "ActivePower_Output_T", "I16", "0.01", "kW"},
		{0x04A6, "ReactivePower_Output_T", "I16", "0.01", "kvar"},
		{0x04A7, "PowerFactor_Output_T", "I16", "0.001", "p.u."},
		{0x04A8, "Current_PCC_T", "U16", "0.01", "A"},
		{0x04A9, "ActivePower_PCC_T", "I16", "0.01", "kW"},
		{0x04AA, "ReactivePower_PCC_T", "I16", "0.01", "kvar"},
